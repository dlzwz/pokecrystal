DEF GOLDENRODGAMECORNER_TM25_COINS      EQU 55
DEF GOLDENRODGAMECORNER_TM14_COINS      EQU 55
DEF GOLDENRODGAMECORNER_TM38_COINS      EQU 55
DEF GOLDENRODGAMECORNER_ABRA_COINS      EQU 1
DEF GOLDENRODGAMECORNER_CUBONE_COINS    EQU 8
DEF GOLDENRODGAMECORNER_WOBBUFFET_COINS EQU 15
