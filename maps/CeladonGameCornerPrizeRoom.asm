DEF CELADONGAMECORNERPRIZEROOM_TM32_COINS     EQU 15
DEF CELADONGAMECORNERPRIZEROOM_TM29_COINS     EQU 35
DEF CELADONGAMECORNERPRIZEROOM_TM15_COINS     EQU 75
DEF CELADONGAMECORNERPRIZEROOM_PIKACHU_COINS  EQU 22
DEF CELADONGAMECORNERPRIZEROOM_PORYGON_COINS  EQU 55
DEF CELADONGAMECORNERPRIZEROOM_LARVITAR_COINS EQU 88
